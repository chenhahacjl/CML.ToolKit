...
- [ ] CML.CommonEx <常用工具包>
	- [ ] Configuration <配置操作工具>
		...
		- [x] RegOperate <注册表操作类>
		- [x] RegOperate(ExFunction) <注册表操作类(扩展方法)>
	- [ ] DataBase <数据库操作工具>
		- [x] MySQL <MySQL数据库支持库>
	...
	- [ ] Encode <数据编码工具>
		...
		- [x] DESEncrypt(ExFunction) <DES加密解密操作类(扩展方法)>
		- [x] MD5Encrypt <MD5加密操作类>
		- [x] MD5Encrypt(ExFunction) <MD5加密操作类(扩展方法)>
	- [ ] Enum <枚举操作工具>
		- [x] EnumOperate <枚举操作类>
		- [x] EnumOperate(ExFunction) <枚举操作类(扩展方法)>
	- [ ] Network <网络操作工具>		
		- [x] DownloadOperate <下载操作类>
		- [x] DownloadOperate(ExFunction) <下载操作类(扩展方法)>
	- [ ] Singleton <单实例工具>
		- [x] SingletonBase <单实例类基类>
	- [ ] Regex <正则表达式工具>
		- [x] RegexOperate <正则表达式帮助类>
		- [x] RegexOperate(ExFunction) <正则表达式帮助类(扩展方法)>
	- [ ] Thread <线程操作工具>
		- [x] InvokeOperate <委托帮助类>
		- [x] InvokeOperate(ExFunction) <委托帮助类(扩展方法)>
	- [ ] UIAutomation <UI自动化操作工具>
		- [x] UIAutomationOperate <UI自动化操作类>
		- [x] UIAutomationOperate(ExFunction) <UI自动化操作类(扩展方法)>
	- [ ] Version <版本管控工具>
