...
namespace CML.CommonEx.FTPEx.ExFunction
{
    ...
    public static class FTPOperateEF
    {
        ...
        public static bool CF_CanConnect(this ModelFtpInfomation ftpInfomation, out string errMsg)
        {
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        /// <returns>检测情况</returns>
        public static EExistence CF_IsExistFile(this ModelFtpInfomation ftpInfomation, out string errMsg)
        {
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        /// <returns>检测情况</returns>
        public static EExistence CF_IsExistDirectory(this ModelFtpInfomation ftpInfomation, out string errMsg)
        {
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        /// <returns>检测情况</returns>
        public static EExistence CF_IsExist(this ModelFtpInfomation ftpInfomation, string tarName, out string errMsg)
        {
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        /// <returns>检测情况</returns>
        public static EExistence CF_IsExistFile(this ModelFtpInfomation ftpInfomation, string fileName, out string errMsg)
        {
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        /// <returns>检测情况</returns>
        public static EExistence CF_IsExistDirectory(this ModelFtpInfomation ftpInfomation, string dirName, out string errMsg)
        {
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        public static bool CF_UploadFile(this ModelFtpInfomation ftpInfomation, string fileName, string filePath, bool overwrite, out string errMsg)
        {
        ...
        /// <param name="overwrite">是否覆盖文件</param>
        /// <param name="errMsg">[OUT]错误信息</param>
        public static bool CF_DownloadFile(this ModelFtpInfomation ftpInfomation, string fileName, string filePath, bool overwrite, out string errMsg)
        {
        ...
        public static bool CF_DeleteFile(this ModelFtpInfomation ftpInfomation, string fileName, out string errMsg)
        {
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        /// <returns>删除情况</returns>
        public static bool CF_DeleteDirectory(this ModelFtpInfomation ftpInfomation, string dirName, out string errMsg)
        {
        ...
        public static bool CF_RenameFile(this ModelFtpInfomation ftpInfomation, string orgFileName, string tarFileName, out string errMsg)
        {
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        /// <returns>重命名情况</returns>
        public static bool CF_RenameDirectory(this ModelFtpInfomation ftpInfomation, string orgDirName, string tarDirName, out string errMsg)
        {
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        /// <returns></returns>
        public static bool CF_MakeDirectory(this ModelFtpInfomation ftpInfomation, string dirName, out string errMsg)
        {
        ...
        public static long CF_GetFileSize(this ModelFtpInfomation ftpInfomation, string fileName, out string errMsg)
        {
        ...
        public static List<ModelFileInfo> CF_GetDirectory(this ModelFtpInfomation ftpInfomation, out string errMsg)
        {
        ...
        public static List<ModelFileInfo> CF_GetFile(this ModelFtpInfomation ftpInfomation, out string errMsg)
        {
        ...
        public static List<ModelFileInfo> CF_GetFileAndDirectory(this ModelFtpInfomation ftpInfomation, out string errMsg)
        {
        ...
        public static FtpWebResponse CF_GetFtpResponse(this ModelFtpInfomation ftpInfomation, out string errMsg)
        {
        ...
        public static FtpWebRequest CF_GetFtpRequest(this ModelFtpInfomation ftpInfomation, out string errMsg)
        {
