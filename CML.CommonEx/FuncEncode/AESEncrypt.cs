...
namespace CML.CommonEx.EncodeEx
{
    ...
    public class AESEncrypt
    {
        ...
        public static bool CF_EncryptFile(ModelAESParameter aesPara, string inFilePath, string outFilePath, out string errMsg)
        {
            bool result;
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        /// <returns>执行结果</returns>
        public static bool CF_DecryptFile(ModelAESParameter aesPara, string inFilePath, string outFilePath, out string errMsg)
        {
            bool result;
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        /// <returns>执行结果</returns>
        public static bool CF_EncryptString(ModelAESParameter aesPara, string inString, out string outString, out string errMsg)
        {
            bool result;
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        /// <returns>执行结果</returns>
        public static bool CF_DecryptString(ModelAESParameter aesPara, string inString, out string outString, out string errMsg)
        {
            bool result;
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        /// <returns>执行结果</returns>
        public static bool CF_EncryptBytes(ModelAESParameter aesPara, byte[] inBytes, out byte[] outBytes, out string errMsg)
        {
            bool result;
        ...
        /// <param name="errMsg">[OUT]错误信息</param>
        /// <returns>执行结果</returns>
        public static bool CF_DecryptBytes(ModelAESParameter aesPara, byte[] inBytes, out byte[] outBytes, out string errMsg)
        {
            bool result;
