...
namespace CML.ToolKit.ControlEx
{
    ...
    public class VersionInfo
    {
        ...
        /// 主版本号
        /// </summary>
        public string VerMain => "1.2";
        /// <summary>
        /// 研发版本号
        /// </summary>
        public string VerDev => "19Y003R001";
        /// <summary>
        /// 更新时间
        /// </summary>
        public string VerDate => "2019年06月19日 15:05";
        #endregion
        ...
        {
            string filePath = "CML.ToolKit.ControlEx.Version.UpdateInfo.LOG";
